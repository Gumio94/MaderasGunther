...
Todas las maderas cumplen con el protocolo normativo de los planes de manejo forestal.</p>
        ...
        <div class="col-md-8 col-lg-6 mb-3 px-1 py-1 bg-negro">
            <div id="fotos" class="carousel slide mx-auto" data-ride="carousel">
                <ol class="carousel-indicators">
                    ...
                    <li data-target="#fotos" data-slide-to="7"></li>
                    <li data-target="#fotos" data-slide-to="8"></li>
